...
This skeleton was forked from the [Aurelia](http://www.aurelia.io/) platform. It sets up a standard navigation-style app using gulp to build your ES6 code with the Babel compiler and shows what I consider to be a good method for loading/displaying a d3 chart. Karma/Protractor/Jasmine testing is also configured.
